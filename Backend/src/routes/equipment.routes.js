...
router.get('/vendor/my-equipment', auth, rbac(['VENDOR']), equipmentController.getVendorEquipment);

// Update equipment
router.put('/:equipmentId', auth, rbac(['VENDOR']), equipmentController.updateEquipment);
